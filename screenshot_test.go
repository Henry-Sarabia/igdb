...
func TestScreenshotService_Get(t *testing.T) {
	...
	var tests = []struct {
		...
		{"Valid response", testScreenshotGet, 65852, []FuncOption{SetFields("name")}, init[0], nil},
		{"Invalid ID", testFileEmpty, -1, nil, nil, ErrNegativeID},
		{"Empty response", testFileEmpty, 65852, nil, nil, errInvalidJSON},
		{"Invalid option", testFileEmpty, 65852, []FuncOption{SetOffset(99999)}, nil, ErrOutOfRange},
...
func TestScreenshotService_List(t *testing.T) {
	...
	var tests = []struct {
		...
		{"Valid response", testScreenshotList, []int{740, 210478, 210664, 210757}, []FuncOption{SetLimit(5)}, init, nil},
		{"Zero IDs", testFileEmpty, nil, nil, nil, ErrEmptyIDs},
		{"Invalid ID", testFileEmpty, []int{-500}, nil, nil, ErrNegativeID},
		{"Empty response", testFileEmpty, []int{740, 210478, 210664, 210757}, nil, nil, errInvalidJSON},
		{"Invalid option", testFileEmpty, []int{740, 210478, 210664, 210757}, []FuncOption{SetOffset(99999)}, nil, ErrOutOfRange},
...
func TestScreenshotService_Index(t *testing.T) {
	...
	tests := []struct {
		...
		{"Valid response", testScreenshotList, []FuncOption{SetLimit(5)}, init, nil},
