...
func TestFranchisesList(t *testing.T) {
	var franchiseTests = []struct {
		...
		{"Happy path", "test_data/franchises_list.txt", []int{9, 22}, []FuncOption{OptLimit(5)}, ""},
		...
		{"Invalid option", "test_data/empty.txt", []int{9, 22}, []FuncOption{OptOffset(9999)}, ErrOutOfRange.Error()},
...
func TestSearchFranchises(t *testing.T) {
	var franchiseTests = []struct {
		...
		{"Happy path", "test_data/franchises_search.txt", "super", []FuncOption{OptLimit(50)}, ""},
		...
		{"Invalid option", "test_data/empty.txt", "super", []FuncOption{OptOffset(9999)}, ErrOutOfRange.Error()},
