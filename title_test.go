...
func TestGetTitle(t *testing.T) {
	ts, c, err := testServerFile(http.StatusOK, "test_data/get_title.txt")
	if err != nil {
		t.Fatal(err)
	}
	defer ts.Close()
...
func TestGetTitles(t *testing.T) {
	ts, c, err := testServerFile(http.StatusOK, "test_data/get_titles.txt")
	if err != nil {
		t.Fatal(err)
	}
	defer ts.Close()
...
func TestSearchTitles(t *testing.T) {
	ts, c, err := testServerFile(http.StatusOK, "test_data/search_titles.txt")
	if err != nil {
		t.Fatal(err)
	}
	defer ts.Close()
