...
func TestCreditsList(t *testing.T) {
	var creditTests = []struct {
		...
		{"Happy path", "test_data/credits_list.txt", []int{1342181334, 1342186852}, []FuncOption{SetLimit(5)}, ""},
		...
		{"Invalid option", "test_data/empty.txt", []int{1342181334, 1342186852}, []FuncOption{SetOffset(99999)}, ErrOutOfRange.Error()},
...
func TestCreditsSearch(t *testing.T) {
	var creditTests = []struct {
		...
		{"Happy path", "test_data/credits_search.txt", "jim", []FuncOption{SetLimit(50)}, ""},
		...
		{"Invalid option", "test_data/empty.txt", "jim", []FuncOption{SetOffset(99999)}, ErrOutOfRange.Error()},
