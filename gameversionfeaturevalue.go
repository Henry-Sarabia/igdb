...
func (gs *GameVersionFeatureValueService) Get(id int, opts ...FuncOption) (*GameVersionFeatureValue, error) {
	if id < 0 {
...
func (gs *GameVersionFeatureValueService) List(ids []int, opts ...FuncOption) ([]*GameVersionFeatureValue, error) {
	for len(ids) < 1 {
...
func (gs *GameVersionFeatureValueService) Index(opts ...FuncOption) ([]*GameVersionFeatureValue, error) {
	var val []*GameVersionFeatureValue
...
func (gs *GameVersionFeatureValueService) Count(opts ...FuncOption) (int, error) {
