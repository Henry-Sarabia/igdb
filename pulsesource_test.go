...
func TestPulseSourcesList(t *testing.T) {
	var pulseSourceTests = []struct {
		...
		{"Happy path", "test_data/pulsesources_list.txt", []int{6, 10}, []FuncOption{OptLimit(5)}, ""},
		...
		{"Invalid option", "test_data/empty.txt", []int{6, 10}, []FuncOption{OptOffset(9999)}, ErrOutOfRange.Error()},
...
func TestPulseSourcesSearch(t *testing.T) {
	var pulseSourceTests = []struct {
		...
		{"Happy path", "test_data/pulsesources_search.txt", "game", []FuncOption{OptLimit(50)}, ""},
		...
		{"Invalid option", "test_data/empty.txt", "game", []FuncOption{OptOffset(9999)}, ErrOutOfRange.Error()},
