...
func TestPlatformsList(t *testing.T) {
	var platformTests = []struct {
		...
		{"Happy path", "test_data/platforms_list.txt", []int{23, 130}, []FuncOption{OptLimit(5)}, ""},
		...
		{"Invalid option", "test_data/empty.txt", []int{23, 130}, []FuncOption{OptOffset(9999)}, ErrOutOfRange.Error()},
...
func TestPlatformsSearch(t *testing.T) {
	var platformTests = []struct {
		...
		{"Happy path", "test_data/platforms_search.txt", "xbox", []FuncOption{OptLimit(50)}, ""},
		...
		{"Invalid option", "test_data/empty.txt", "xbox", []FuncOption{OptOffset(9999)}, ErrOutOfRange.Error()},
