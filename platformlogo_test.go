...
func TestPlatformLogoService_Get(t *testing.T) {
	...
	var tests = []struct {
		...
		{"Valid response", testPlatformLogoGet, 61, []FuncOption{SetFields("name")}, init[0], nil},
		{"Invalid ID", testFileEmpty, -1, nil, nil, ErrNegativeID},
		{"Empty response", testFileEmpty, 61, nil, nil, errInvalidJSON},
		{"Invalid option", testFileEmpty, 61, []FuncOption{SetOffset(99999)}, nil, ErrOutOfRange},
...
func TestPlatformLogoService_List(t *testing.T) {
	...
	var tests = []struct {
		...
		{"Valid response", testPlatformLogoList, []int{32, 23, 41, 49, 34}, []FuncOption{SetLimit(5)}, init, nil},
		{"Zero IDs", testFileEmpty, nil, nil, nil, ErrEmptyIDs},
		{"Invalid ID", testFileEmpty, []int{-500}, nil, nil, ErrNegativeID},
		{"Empty response", testFileEmpty, []int{32, 23, 41, 49, 34}, nil, nil, errInvalidJSON},
		{"Invalid option", testFileEmpty, []int{32, 23, 41, 49, 34}, []FuncOption{SetOffset(99999)}, nil, ErrOutOfRange},
...
func TestPlatformLogoService_Index(t *testing.T) {
	...
	tests := []struct {
		...
		{"Valid response", testPlatformLogoList, []FuncOption{SetLimit(5)}, init, nil},
