...
func TestMultiplayerModeService_Get(t *testing.T) {
	...
	var tests = []struct {
		...
		{"Valid response", testMultiplayerModeGet, 4905, []FuncOption{SetFields("name")}, init[0], nil},
		{"Invalid ID", testFileEmpty, -1, nil, nil, ErrNegativeID},
		{"Empty response", testFileEmpty, 4905, nil, nil, errInvalidJSON},
		{"Invalid option", testFileEmpty, 4905, []FuncOption{SetOffset(99999)}, nil, ErrOutOfRange},
...
func TestMultiplayerModeService_List(t *testing.T) {
	...
	var tests = []struct {
		...
		{"Valid response", testMultiplayerModeList, []int{4907, 8632, 8678, 8687, 34}, []FuncOption{SetLimit(5)}, init, nil},
		{"Zero IDs", testFileEmpty, nil, nil, nil, ErrEmptyIDs},
		{"Invalid ID", testFileEmpty, []int{-500}, nil, nil, ErrNegativeID},
		{"Empty response", testFileEmpty, []int{4907, 8632, 8678, 8687, 34}, nil, nil, errInvalidJSON},
		{"Invalid option", testFileEmpty, []int{4907, 8632, 8678, 8687, 34}, []FuncOption{SetOffset(99999)}, nil, ErrOutOfRange},
...
func TestMultiplayerModeService_Index(t *testing.T) {
	...
	tests := []struct {
		...
		{"Valid response", testMultiplayerModeList, []FuncOption{SetLimit(5)}, init, nil},
