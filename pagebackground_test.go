...
func TestPageBackgroundService_Get(t *testing.T) {
	...
	var tests = []struct {
		...
		{"Valid response", testPageBackgroundGet, 1, []FuncOption{SetFields("name")}, init[0], nil},
		{"Invalid ID", testFileEmpty, -1, nil, nil, ErrNegativeID},
		{"Empty response", testFileEmpty, 1, nil, nil, errInvalidJSON},
		{"Invalid option", testFileEmpty, 1, []FuncOption{SetOffset(99999)}, nil, ErrOutOfRange},
...
func TestPageBackgroundService_List(t *testing.T) {
	...
	var tests = []struct {
		...
		{"Valid response", testPageBackgroundList, []int{2, 3, 4, 5, 6}, []FuncOption{SetLimit(5)}, init, nil},
		{"Zero IDs", testFileEmpty, nil, nil, nil, ErrEmptyIDs},
		{"Invalid ID", testFileEmpty, []int{-500}, nil, nil, ErrNegativeID},
		{"Empty response", testFileEmpty, []int{2, 3, 4, 5, 6}, nil, nil, errInvalidJSON},
		{"Invalid option", testFileEmpty, []int{2, 3, 4, 5, 6}, []FuncOption{SetOffset(99999)}, nil, ErrOutOfRange},
...
func TestPageBackgroundService_Index(t *testing.T) {
	...
	tests := []struct {
		...
		{"Valid response", testPageBackgroundList, []FuncOption{SetLimit(5)}, init, nil},
