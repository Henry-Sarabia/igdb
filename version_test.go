...
func TestVersionsList(t *testing.T) {
	var versionTests = []struct {
		...
		{"Happy path", "test_data/versions_list.txt", []int{100, 200}, []OptionFunc{OptLimit(5)}, ""},
		...
		{"Invalid option", "test_data/empty.txt", []int{100, 200}, []OptionFunc{OptOffset(9999)}, ErrOutOfRange.Error()},
