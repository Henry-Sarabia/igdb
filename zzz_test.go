...
const (
	...
	testZypeSearch string = "test_data/zype_search.json"
)
...
func TestZypeService_Get(t *testing.T) {
	...
	var tests = []struct {
		...
		{"Valid response", testZypeGet, 7346, []FuncOption{SetFields("name")}, init[0], nil},
...
func TestZypeService_List(t *testing.T) {
	...
	var tests = []struct {
		...
		{"Valid response", testZypeList, []int{1721, 2777}, []FuncOption{SetLimit(5)}, init, nil},
