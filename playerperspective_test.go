...
func TestPlayerPerspectiveService_Get(t *testing.T) {
	...
	var tests = []struct {
		...
		{"Valid response", testPlayerPerspectiveGet, 4, []FuncOption{SetFields("name")}, init[0], nil},
		{"Invalid ID", testFileEmpty, -1, nil, nil, ErrNegativeID},
		{"Empty response", testFileEmpty, 4, nil, nil, errInvalidJSON},
		{"Invalid option", testFileEmpty, 4, []FuncOption{SetOffset(99999)}, nil, ErrOutOfRange},
...
func TestPlayerPerspectiveService_List(t *testing.T) {
	...
	var tests = []struct {
		...
		{"Valid response", testPlayerPerspectiveList, []int{2, 5, 7, 1, 3}, []FuncOption{SetLimit(5)}, init, nil},
		{"Zero IDs", testFileEmpty, nil, nil, nil, ErrEmptyIDs},
		{"Invalid ID", testFileEmpty, []int{-500}, nil, nil, ErrNegativeID},
		{"Empty response", testFileEmpty, []int{2, 5, 7, 1, 3}, nil, nil, errInvalidJSON},
		{"Invalid option", testFileEmpty, []int{2, 5, 7, 1, 3}, []FuncOption{SetOffset(99999)}, nil, ErrOutOfRange},
...
func TestPlayerPerspectiveService_Index(t *testing.T) {
	...
	tests := []struct {
		...
		{"Valid response", testPlayerPerspectiveList, []FuncOption{SetLimit(5)}, init, nil},
