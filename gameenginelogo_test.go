...
func TestGameEngineLogoService_Get(t *testing.T) {
	...
	var tests = []struct {
		...
		{"Valid response", testGameEngineLogoGet, 9, []FuncOption{SetFields("name")}, init[0], nil},
		{"Invalid ID", testFileEmpty, -1, nil, nil, ErrNegativeID},
		{"Empty response", testFileEmpty, 9, nil, nil, errInvalidJSON},
		{"Invalid option", testFileEmpty, 9, []FuncOption{SetOffset(99999)}, nil, ErrOutOfRange},
...
func TestGameEngineLogoService_List(t *testing.T) {
	...
	var tests = []struct {
		...
		{"Valid response", testGameEngineLogoList, []int{11, 12, 31, 44, 51}, []FuncOption{SetLimit(5)}, init, nil},
		{"Zero IDs", testFileEmpty, nil, nil, nil, ErrEmptyIDs},
		{"Invalid ID", testFileEmpty, []int{-500}, nil, nil, ErrNegativeID},
		{"Empty response", testFileEmpty, []int{11, 12, 31, 44, 51}, nil, nil, errInvalidJSON},
		{"Invalid option", testFileEmpty, []int{11, 12, 31, 44, 51}, []FuncOption{SetOffset(99999)}, nil, ErrOutOfRange},
...
func TestGameEngineLogoService_Index(t *testing.T) {
	...
	tests := []struct {
		...
		{"Valid response", testGameEngineLogoList, []FuncOption{SetLimit(5)}, init, nil},
