...
func TestPerspectivesList(t *testing.T) {
	var perspectiveTests = []struct {
		...
		{"Happy path", "test_data/perspectives_list.txt", []int{6, 3}, []FuncOption{OptLimit(5)}, ""},
		...
		{"Invalid option", "test_data/empty.txt", []int{6, 3}, []FuncOption{OptOffset(9999)}, ErrOutOfRange.Error()},
...
func TestPerspectivesSearch(t *testing.T) {
	var perspectiveTests = []struct {
		...
		{"Happy path", "test_data/perspectives_search.txt", "person", []FuncOption{OptLimit(50)}, ""},
		...
		{"Invalid option", "test_data/empty.txt", "person", []FuncOption{OptOffset(9999)}, ErrOutOfRange.Error()},
