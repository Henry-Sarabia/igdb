...
func TestCompanyWebsiteService_Get(t *testing.T) {
	...
	var tests = []struct {
		...
		{"Valid response", testCompanyWebsiteGet, 1707, []FuncOption{SetFields("name")}, init[0], nil},
		{"Invalid ID", testFileEmpty, -1, nil, nil, ErrNegativeID},
		{"Empty response", testFileEmpty, 1707, nil, nil, errInvalidJSON},
		{"Invalid option", testFileEmpty, 1707, []FuncOption{SetOffset(99999)}, nil, ErrOutOfRange},
...
func TestCompanyWebsiteService_List(t *testing.T) {
	...
	var tests = []struct {
		...
		{"Valid response", testCompanyWebsiteList, []int{1709, 453, 1710, 1322, 133}, []FuncOption{SetLimit(5)}, init, nil},
		{"Zero IDs", testFileEmpty, nil, nil, nil, ErrEmptyIDs},
		{"Invalid ID", testFileEmpty, []int{-500}, nil, nil, ErrNegativeID},
		{"Empty response", testFileEmpty, []int{1709, 453, 1710, 1322, 133}, nil, nil, errInvalidJSON},
		{"Invalid option", testFileEmpty, []int{1709, 453, 1710, 1322, 133}, []FuncOption{SetOffset(99999)}, nil, ErrOutOfRange},
...
func TestCompanyWebsiteService_Index(t *testing.T) {
	...
	tests := []struct {
		...
		{"Valid response", testCompanyWebsiteList, []FuncOption{SetLimit(5)}, init, nil},
