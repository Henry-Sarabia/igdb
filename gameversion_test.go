...
func TestGameVersionService_Get(t *testing.T) {
	...
	var tests = []struct {
		...
		{"Valid response", testGameVersionGet, 59, []FuncOption{SetFields("name")}, init[0], nil},
		{"Invalid ID", testFileEmpty, -1, nil, nil, ErrNegativeID},
		{"Empty response", testFileEmpty, 59, nil, nil, errInvalidJSON},
		{"Invalid option", testFileEmpty, 59, []FuncOption{SetOffset(99999)}, nil, ErrOutOfRange},
...
func TestGameVersionService_List(t *testing.T) {
	...
	var tests = []struct {
		...
		{"Valid response", testGameVersionList, []int{131, 95, 101, 109, 128}, []FuncOption{SetLimit(5)}, init, nil},
		{"Zero IDs", testFileEmpty, nil, nil, nil, ErrEmptyIDs},
		{"Invalid ID", testFileEmpty, []int{-500}, nil, nil, ErrNegativeID},
		{"Empty response", testFileEmpty, []int{131, 95, 101, 109, 128}, nil, nil, errInvalidJSON},
		{"Invalid option", testFileEmpty, []int{131, 95, 101, 109, 128}, []FuncOption{SetOffset(99999)}, nil, ErrOutOfRange},
...
func TestGameVersionService_Index(t *testing.T) {
	...
	tests := []struct {
		...
		{"Valid response", testGameVersionList, []FuncOption{SetLimit(5)}, init, nil},
