...
func TestCoverService_Get(t *testing.T) {
	...
	var tests = []struct {
		...
		{"Valid response", testCoverGet, 63541, []FuncOption{SetFields("name")}, init[0], nil},
		{"Invalid ID", testFileEmpty, -1, nil, nil, ErrNegativeID},
		{"Empty response", testFileEmpty, 63541, nil, nil, errInvalidJSON},
		{"Invalid option", testFileEmpty, 63541, []FuncOption{SetOffset(99999)}, nil, ErrOutOfRange},
...
func TestCoverService_List(t *testing.T) {
	...
	var tests = []struct {
		...
		{"Valid response", testCoverList, []int{54614, 9206, 15242, 43854, 27257}, []FuncOption{SetLimit(5)}, init, nil},
		{"Zero IDs", testFileEmpty, nil, nil, nil, ErrEmptyIDs},
		{"Invalid ID", testFileEmpty, []int{-500}, nil, nil, ErrNegativeID},
		{"Empty response", testFileEmpty, []int{54614, 9206, 15242, 43854, 27257}, nil, nil, errInvalidJSON},
		{"Invalid option", testFileEmpty, []int{54614, 9206, 15242, 43854, 27257}, []FuncOption{SetOffset(99999)}, nil, ErrOutOfRange},
...
func TestCoverService_Index(t *testing.T) {
	...
	tests := []struct {
		...
		{"Valid response", testCoverList, []FuncOption{SetLimit(5)}, init, nil},
