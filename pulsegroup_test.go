...
func TestPulseGroupsList(t *testing.T) {
	var pulseGroupTests = []struct {
		...
		{"Happy path", "test_data/pulsegroups_list.txt", []int{2096, 1108}, []FuncOption{OptLimit(5)}, ""},
...
func TestPulseGroupsSearch(t *testing.T) {
	var pulseGroupTests = []struct {
		...
		{"Happy path", "test_data/pulsegroups_search.txt", "League of Legends", []FuncOption{OptLimit(50)}, ""},
		...
		{"Invalid option", "test_data/empty.txt", "League of Legends", []FuncOption{OptOffset(9999)}, ErrOutOfRange.Error()},
