...
func TestGameEngineService_Get(t *testing.T) {
	...
	var tests = []struct {
		...
		{"Valid response", testGameEngineGet, 7346, []FuncOption{SetFields("name")}, init[0], nil},
...
func TestGameEngineService_List(t *testing.T) {
	...
	var tests = []struct {
		...
		{"Valid response", testGameEngineList, []int{1721, 2777}, []FuncOption{SetLimit(5)}, init, nil},
