...
func (zs *ZypeService) Get(id int, opts ...FuncOption) (*Zype, error) {
	if id < 0 {
...
func (zs *ZypeService) List(ids []int, opts ...FuncOption) ([]*Zype, error) {
	for len(ids) < 1 {
...
func (zs *ZypeService) Index(opts ...FuncOption) ([]*Zype, error) {
	var z []*Zype
...
func (zs *ZypeService) Search(qry string, opts ...FuncOption) ([]*Zype, error) {
	var z []*Zype
...
func (zs *ZypeService) Count(opts ...FuncOption) (int, error) {
