...
func TestPlatformVersionService_Get(t *testing.T) {
	...
	var tests = []struct {
		...
		{"Valid response", testPlatformVersionGet, 106, []FuncOption{SetFields("name")}, init[0], nil},
		{"Invalid ID", testFileEmpty, -1, nil, nil, ErrNegativeID},
		{"Empty response", testFileEmpty, 106, nil, nil, errInvalidJSON},
		{"Invalid option", testFileEmpty, 106, []FuncOption{SetOffset(99999)}, nil, ErrOutOfRange},
...
func TestPlatformVersionService_List(t *testing.T) {
	...
	var tests = []struct {
		...
		{"Valid response", testPlatformVersionList, []int{147, 35, 62, 150, 183}, []FuncOption{SetLimit(5)}, init, nil},
		{"Zero IDs", testFileEmpty, nil, nil, nil, ErrEmptyIDs},
		{"Invalid ID", testFileEmpty, []int{-500}, nil, nil, ErrNegativeID},
		{"Empty response", testFileEmpty, []int{147, 35, 62, 150, 183}, nil, nil, errInvalidJSON},
		{"Invalid option", testFileEmpty, []int{147, 35, 62, 150, 183}, []FuncOption{SetOffset(99999)}, nil, ErrOutOfRange},
...
func TestPlatformVersionService_Index(t *testing.T) {
	...
	tests := []struct {
		...
		{"Valid response", testPlatformVersionList, []FuncOption{SetLimit(5)}, init, nil},
